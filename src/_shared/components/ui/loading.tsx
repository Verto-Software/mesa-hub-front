...
export function Loading({ size = 'md' }: LoadingProps) {
   ...
   return (
      <svg
         aria-hidden='true'
         className={`${sizeClasses} text-gray-200 animate-spin dark:text-gray-600 fill-[#8347eb] `}
         viewBox='0 0 100 101'
         fill='none'
      ...
      >
         <path
           ...
           50.5908ZM9.08144 50.5908C9.08144 73.1865 
         ...
         <path
           ...
           9.52689 55.5402 10.0491C60.864 10.7766 
           65.9921 12.5457 70.6331 15.2552C75.274 17.9648 
           79.3347 21.5619 82.5849 25.841C84.9175 
           28.9121 86.7993 32.2913 88.1811 35.8758C89.083 
